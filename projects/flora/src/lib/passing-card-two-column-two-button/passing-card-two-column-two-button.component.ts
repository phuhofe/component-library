...
@Component({
  selector: 'flora-passing-card-two-column-two-button',
  templateUrl: './passing-card-two-column-two-button.component.html',
  styleUrls: ['./passing-card-two-column-two-button.component.scss'],
  encapsulation: ViewEncapsulation.ShadowDom,
})
export class PassingCardTwoColumnTwoButtonComponent extends FloraComponent implements OnInit, OnChanges {
  @Input() order: any;
