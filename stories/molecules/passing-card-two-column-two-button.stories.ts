...
import {
  PassingCardTwoColumnTwoButtonComponent,
  DefaultLoadingPhoto,
  DefaultFallbackPhoto,
} from '@flora/lib/passing-card-two-column-two-button/passing-card-two-column-two-button.component';
import { PassingCardTwoColumnTwoButtonModule } from '@flora/lib/passing-card-two-column-two-button/passing-card-two-column-two-button.module';
import { ControlType, floraStoryWrapper } from '../utils';
import { OrderData as order } from '@flora/lib/mock/mock-order-passing-card-two-column-two-button';

export default {
  title: 'Molecules/Passing Card Two Column Two Button',
  component: PassingCardTwoColumnTwoButtonComponent,
  decorators: [
    moduleMetadata({
      imports: [PassingCardTwoColumnTwoButtonModule],
    }),
